...
--autostart
myStartupHook = do
          spawnOnce "trayer-srg --edge top --align right --widthtype request --padding 12 --SetDockType true --SetPartialStrut true --expand true --monitor 1 --transparent true --alpha 0 --tint 0x282c34  --height 35 &"
          spawnOnce "picom"
